...
let favoriteFoods = ["Tacos", "Pizza", "Burgers", "Turkey", "Ham", "Grapes"];
...
console.log("My #2 favorite food is Pizza");
console.log("My #3 favorite food is Burgers");
console.log("My #4 favorite food is Turkey");
console.log("My #5 favorite food is Ham");
console.log("My #6 favorite food is Grapes");
...
printFoodRecommendation("watermelon");
...
if (longFoodNames < shortFoodNames) {
